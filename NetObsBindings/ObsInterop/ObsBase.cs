...
public static unsafe partial class ObsBase
{
    ...
    [DllImport("obs", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern void blogva(int log_level, [NativeTypeName("const char *")] sbyte* format, [NativeTypeName("va_list")] sbyte* args);

    [DllImport("obs", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern void blog(int log_level, [NativeTypeName("const char *")] sbyte* format, __arglist);
    ...
    public static ReadOnlySpan<byte> S__LINE__ => new byte[] { 0x31, 0x37, 0x37, 0x00 };

    [NativeTypeName("#define INT_CUR_LINE __LINE__")]
    public const int INT_CUR_LINE = 179;

    [NativeTypeName("#define FILE_LINE __FILE__ \" (\" S__LINE__ \"): \"")]
    public static ReadOnlySpan<byte> FILE_LINE => new byte[] { 0x2E, 0x5C, 0x6F, 0x62, 0x73, 0x2D, 0x73, 0x74, 0x75, 0x64, 0x69, 0x6F, 0x5C, 0x6C, 0x69, 0x62, 0x6F, 0x62, 0x73, 0x5C, 0x6F, 0x62, 0x73, 0x2D, 0x6D, 0x6F, 0x64, 0x75, 0x6C, 0x65, 0x2E, 0x68, 0x20, 0x28, 0x31, 0x38, 0x31, 0x29, 0x3A, 0x20, 0x00 };
}
