...
$outputFolder = ".\NetObsBindings\ObsInterop\Generated"
rm $outputFolder -Confirm:$false -Force -Recurse
mkdir $outputFolder
...
rm $outputFolder\System.Numerics.Quaternion.cs <# This file is wrongly generated by ClangSharpGenerator #>